...
//		FBoneSocketTarget LookAtTarget;
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = OptionalInputData, meta = (DisplayName = "Hands Input (optional)"))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = OptionalInputData, meta = (DisplayName = "Main Arm Index"))
...
//		FVector Forward_Direction_Vector = FVector(0, 1, 0);
	...
	/*
	*Only used for internal animation blueprint viewport for debugging. Real gameworld uses "LookAtLocation"
    */
